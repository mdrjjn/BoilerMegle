...
function start() {
	...
	socket.on('updatechat', function(username, data) {
		...
		if (username === 'SERVER-VOTES') {
			switch (data.vote) {
				case 'A':
					$('#votesForA').text('A: ' + (parseInt($('#votesForA').text().split(' ')[1]) + 1))

					break;
				case 'B':
					$('#votesForB').text('B: ' + (parseInt($('#votesForB').text().split(' ')[1]) + 1))

					break;
				case 'C':
					$('#votesForC').text('C: ' + (parseInt($('#votesForC').text().split(' ')[1]) + 1))

					break;
				case 'D':
					$('#votesForD').text('D: ' + (parseInt($('#votesForD').text().split(' ')[1]) + 1))
